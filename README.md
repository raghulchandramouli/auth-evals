# AUTH-EVAL – Agents Specification
...
#  Dataset Agent (databunch/ + scripts/)
...
* `label` → 0 = real, 1 = fake
* `generator` → sdxl, dalle3, midjourney, gan, etc.
* `source` → dataset name
* `split` → train / test
* `compression` → none / jpeg90 / resized256 etc.
